...
class AboutLayout(context: Context):LinearLayout(context),View.OnClickListener {
    override fun onClick(p0: View?) {
        when(p0!!.id){
            R.id.ll_card_about_1_feedback->{
                ...
                intent.data = (Uri.parse("mailto:zsh2401@163.com"))
                ...
                Snackbar.make(this,"sss",Snackbar.LENGTH_LONG)
                .setAction("ok",null).show()}
        }
    }
    ...
    init {
        ...
        findViewById<TextView>(R.id.text_view_version).text = App.current.getString(R.string.about_version_name) + " " + getVersionName()
    }
}